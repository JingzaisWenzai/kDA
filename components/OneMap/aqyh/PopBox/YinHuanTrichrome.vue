...
<style scoped>
  ...
  .aqyh_n_a_right{width:24px; height:24px;  position:absolute;left:100%; top:50%; margin-left:-30px;margin-top:-12px; cursor: pointer;}
...
<script>
  ...
  export default{
    ...
    // },
    mounted(){
      this.flag = this.$store.state.ShowChrome
    },
    watch:{
      flag:{
