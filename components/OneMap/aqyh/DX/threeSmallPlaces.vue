    ...
    <div>
      ...
      <div>
        <div style="width:40%;display: inline-block; ">
          ...
          <div class="detail special" style="width: 100%;" id="threeSmallPlaces_detail_1"></div>
        </div>
        <div style="width:58%;display: inline-block; ">
          <div class="title"><span>隐患事件统计</span></div>
          <div class="detail special" style="width: 100%;" id="threeSmallPlaces_detail_1_1"></div>
        </div>
      </div>
    </div>
    <div>
