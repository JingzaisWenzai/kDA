...
<style  scoped>
  ...
  .h_b{ position: absolute; top:125px; left: 55px; width:575px; height:210px; text-align: left; margin: 0px auto; overflow: hidden; }
  ...
  .h_b_b ul li{/*width:126px;*/ height:50px; line-height: 50px;
    text-align: center; margin: 0px 10px; float: left; display: inline;  overflow: hidden; cursor: pointer;}
