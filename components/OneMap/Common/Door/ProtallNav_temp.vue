...
<style scoped>
  ...
  .protall_pop .nav_box .foldBox .level2 span.close{cursor: pointer;
    margin-left: 50px;
    width: 14px;
    height:14px;
          ...
          return{
            navBths:[
              ...
              {txt:'专题应用',src:special,subBtns:[
                {txt:'安全隐患一张图',url:'http://10.190.55.58:8081/web/OneMap/SecMap/'},
                {txt:'安全隐患（单屏）',url:'http://10.190.55.58:8081/web/OneMapSingle/SecMap/'},
                {txt:'生态环境一张图',url:'http://10.190.55.58:8081/web/OneMap/EcoMap/'},
                {txt:'生态环境（单屏）',url:'http://10.190.55.58:8081/web/OneMapSingle/EcoMap/'},
