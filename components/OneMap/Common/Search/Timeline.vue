...
<style scoped>
  ...
  .timeline_container .content{
    background:transparent url('../../../../static/img/timeline/line.png') repeat-x center;
  ...
  .timeline_container .content a .trick_img{
    display: block;width:100%;height:20px;background: transparent url('../../../../static/img/timeline/trick.png') no-repeat center;
    background-size: contain;
  }
  .timeline_container .content a .trick_name{
    position: absolute;left:0;top:100%;width: 100%;text-align: center; color:#ffffff;font-size: 17px;
  }
  .timeline_container .block{
    position: absolute;
    top:2px;
    left:10px;
    background: transparent url('../../../../static/img/timeline/block.png') no-repeat center;
    background-size: contain;
    width:18px;height:20px;
  }
</style>
<script>
  import left from '../../../../static/img/timeline/left.png';
  import right from '../../../../static/img/timeline/right.png';
   export default{
       data(){
           return{
