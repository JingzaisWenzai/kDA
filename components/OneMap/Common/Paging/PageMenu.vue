...
<style scoped>
  ...
  .pageMenu{    display: block;padding:0; width: 100%; color:#fff; overflow:hidden; clear: both;}
  .pageMenu li{
    padding:0 1%;
  ...
  .pageMenu li.last{cursor: pointer;background: transparent;color:rgba(255,255,255,0.8); border:0;margin-left:2%;margin-right: 2%;}
  ...
  .pageMenu .page-input .keuInput{
    padding: 0 1%;width: 100%;outline: none;display: block;
    text-align: center;
  ...
  .pageMenu .pageObj,.pageMenu li{
    display:block;float:right; line-height: 30px;
  }
  .pageMenu .pageObj li{
    border:1px solid transparent;
