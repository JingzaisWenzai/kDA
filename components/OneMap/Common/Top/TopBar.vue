<template>
  <section class="top_container">
    ...
    <!--<div class="myDatePicker"><date-picker></date-picker></div>-->
...
<style scoped>
  .top_container{
    ...
    height:100%;
    position:relative;
    background:transparent url('../../../../static/img/common/top-bg.png') no-repeat center;
    background-size: contain;
  }
  .top_title_eco{position:absolute; top:50%;left:50%;margin-left: -200px;margin-top: -35px;
    background: url('../../../../static/img/eco/top_tit.png') no-repeat center;
    background-size: contain;
    width:400px;
    height:70px;
  }
  .top_title_sec{position:absolute; top:50%;left:50%;margin-left: -200px;margin-top: -35px;
    background: url('../../../../static/img/sec/top_tit.png') no-repeat center;
    background-size: contain;
    width:400px;
    height:70px;
  }
  .search_bar{ position: absolute;left:60px;top:30%;margin-top:-22px;width:490px;height:44px;}
  .alert_bar{position: absolute;left:660px;top:30%;margin-top:-22px;width:250px;height:44px;}
...
<script>
  ...
  import ProtallNav from '../../../common/ProtallNav';
