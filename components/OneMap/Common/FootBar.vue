<template>
    ...
    <ul class="pagination">
      ...
      <li :class="{'disabled': current == 1}"><a href="javascript:void(0);" @click="setCurrent(1)">首页</a></li>
      ...
      <li ><a href="javascript:;">共{{page}}页 </a></li> <!-- <li>跳转<input type="text" v-model="changePage"></li>
