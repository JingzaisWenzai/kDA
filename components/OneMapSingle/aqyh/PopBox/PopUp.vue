<template>
  <div class="citypop_container">
    <div class="title"><i class="icon"></i><span>{{popupdata.build}}</span><span style="color: red;font-size: 14px">风险源详情</span><i class="close"  @click="toClose"></i></div>
    <div class="navBar">
...
<style>
  ...
  .citypop_container .title .close{
    ...
    background-size: contain;position:absolute; left:100%; top:50%; margin-left: -30px;margin-top: -12px;cursor: pointer;
  }
  ...
  .citypop_container .tableList table thead{width:680px; height:50px; line-height: 50px; text-align: center; margin: 0px auto; overflow: hidden; font-size: 16px; color: #ffffff;}
  .citypop_container .tableList table tbody{width:680px; height:360px; line-height: 36px; text-align: center; margin: 0px auto; overflow: hidden; font-size: 14px; color: #43d3ff;}
