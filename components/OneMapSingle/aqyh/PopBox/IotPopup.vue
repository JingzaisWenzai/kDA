...
<style scoped>
  ...
  .aqyh_t_a_left{width:100%; height:100%; text-align: left; display: block;  font-size: 20px; color: #7af3ff;border-bottom:1px solid #196db4;}
  .aqyh_t_a_left span{display: inline-block;vertical-align:bottom;  width:auto;height:auto;}
  .aqyh_t_a_left span:nth-child(2){ padding:0 15px; font-size: 10px; color: #ffffff; height:20px; margin-left:15px;background-color: #df0000; border-radius:3px;}
  .aqyh_t_a_right{cursor: pointer;width:24px; height:24px;  display: block;  position: absolute;  left:100%; top:50%;margin-left: -30px;margin-top: -12px;cursor: pointer;}
  .aqyh_t_a_right img{width:100%;display: block; height:100%; }

  .aqyh_t_b{cursor:pointer;position:relative;width:95%; height:35px; line-height: 35px;  text-align: left; margin:15px auto 0 auto; padding:0 0 0 15px;  border: rgba(25,109,180,0.8) solid 1px; background-color: rgba(25,109,180,0.5); border-radius:5px; font-size: 14px; color:#c1e9ff;}
  .aqyh_t_b .list_total{ position: absolute;left:15%;  top:50%; margin-top: -17.5px;font-size: 14px; color:#60b6ff;}
  .aqyh_t_c{width:95%; height:auto; text-align: left; margin: 10px auto 0 auto; padding: 0; border: rgba(25,109,180,0.8) solid 1px; font-size: 16px; color: #666666;}
  ...
  .aqyh_t_c ul li span{ display: inline-block; vertical-align: middle; font-size: 14px;color:#7af3ff;}
  ...
  .aqyh_t_d{width:95%;margin: 15px auto 0 auto; height:90px; text-align: left;  overflow: hidden; border: rgba(25,109,180,0.8) solid 1px; font-size: 16px; color: #666666;}
  ...
  .aqyh_t_d ul li .aqyh_t_d_a img{cursor:pointer;width: 39px; height: 39px; margin: 0 auto;display: block;}
  .aqyh_t_d ul li .aqyh_t_d_b{width:auto; height:30px; text-align: center;margin: 10px auto 0 auto; font-size: 12px; color: #7af3ff;overflow: hidden;text-overflow: ellipsis; white-space: nowrap;}
  ...
  .aqyh_t_e table thead{width:100%; height:40px; text-align: center; margin: 0 auto; overflow: hidden; font-size: 13px; color: #7af3ff; background-color: transparent;}
  .aqyh_t_e table thead tr td{width:auto; height:52px;}
  .aqyh_t_e table tbody{width:100%; height:auto; text-align: center; margin: 0 auto; overflow: hidden;  font-size: 13px; color: #5fb6ff;}
  ...
  .aqyh_t_e_a{font-size: 14px; color: #ff1e00;}
  ...
  .aqyh_t_e table tbody tr td p a{text-decoration: none; color: #4e88ff;font-size: 12px;}
  .aqyh_t_e_b a{font-size: 14px; color: #4e88ff; display: block; }
