...
<style scoped>
  ...
  .f_b2{width:100%; height:100%;padding-top: 0;text-align: left; margin: 0 auto; float: left; display: inline;  overflow: hidden; background-color: rgba(2,22,35,0.8); border: 1px solid #196db4; }
  ...
  .f_b_a span{font-size: 18px; color: #ffffff;display: block;width:100%;}
  ...
  .f_b_b_a ul li a{font-size: 14px; color: #ffffff; text-decoration: none; display: block;}
  .f_b_b_a ul li a:hover,.f_b_b_a ul li a.active{font-size: 14px; color: #aad9ff; text-decoration: none; display: block; background-color: #196db4;}
  ...
  .sideBox .hd{cursor:pointer;width:100%;  height: auto;border: 1px solid #4775d0;background-color: rgba(17,51,120, 0.7); -webkit-border-radius:5px;  -moz-border-radius:5px;  border-radius:5px; margin-bottom: 15px;}
  ...
  .sideBox .hd .hd_tit h3{width:90%;height:50px;margin:0 auto;font-weight: 500; font-size: 14px; color:#aad9ff;line-height: 50px;border-bottom:1px solid transparent;}
  ...
  .sideBox .on .hd_content ul li{display: inline-block;vertical-align: middle; color:#aad9ff;font-size: 14px; width:48%;
    padding:8px 0;}
  ...
  .sideBox .on .hd_content ul li span:nth-child(1){max-width: 45%;}
  .sideBox .on .hd_content ul li span:nth-child(2){margin:0 6px 0 3px;}
  .sideBox .on .hd_content ul li span:nth-child(3){font-size: 14px; color: #ff9700;max-width:40%;}
</style>
<script>
