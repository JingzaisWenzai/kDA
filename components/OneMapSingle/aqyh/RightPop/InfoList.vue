...
<style scoped>
  ...
  .aqyh_j_right_e ul li{cursor:pointer;
  ...
  .aqyh_j_right_f_a .aqyh_j_right_b table tbody tr td,
  .tableStyle tbody tr td{cursor:pointer; height:auto;  padding:7px 0;  border-right: #224f77 solid 1px; border-bottom: #224f77 solid 1px;}
