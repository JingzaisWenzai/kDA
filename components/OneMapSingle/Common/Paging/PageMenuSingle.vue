...
<style scoped>
  ...
  .pageMenu li.prevPage{ cursor:pointer; background-color: rgba(23,94,156,0.5); color:#cccccc;font-size: 10px;border: 1px solid #186aaf;}
  .pageMenu li.nextPage{ cursor:pointer;background-color: #175e9c;color:#6ef5f9;font-size: 10px;border: 1px solid #186aaf;}
  ...
  .pageMenu li.last{   cursor:pointer;background: transparent;color:#666666; border:0;margin-left: 15px;margin-right: 15px;}
