...
<style scoped>
  ...
  .search-bar a.clear{
    ...
    width:8.49%;
    height:36px;
    background:transparent url('../../../../static/img/common/search/cross-single.png') center no-repeat;
  ...
  .search-nearby p span{display: inline-block;vertical-align: middle;width:auto;color:#7a7a7a;font-size: 14px;}
  ...
  .search-bar a.clear{
    ...
    width:8.49%;
    height:30px;
    background:transparent url('../../../../static/img/common/search/cross_dkg-single.png') center no-repeat;
    background-size: 18px 18px;
    border:0;
  }
