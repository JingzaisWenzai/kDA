...
<style scoped>
  ...
  .detail_container .title{width:100%;  border-bottom:1px solid rgba(0,0,0,0.5);  text-align: left;margin-top: 16px;}
  .detail_container .title a,
  .detail_container .title span{  display: inline-block; vertical-align: middle;}
  .detail_container .title span{ color: #a7d7ff;font-size: 18px; padding:6px 0; width:calc(100% - 30px);}
  .detail_container .title a{ width:18px; height:18px;}
  .detail_container .title a img{ width: 100%; height:100%; display: block;  cursor:pointer;}
  ...
  .content p {width:100%;display: block;padding:20px 0;color:#cefeff;font-size:18px;font-weight: 800;overflow: hidden;text-overflow: ellipsis; white-space: nowrap; }
  .content a,.content a:hover{text-decoration: none;}
  .content a{width:95%; margin:0 auto;font-size: 16px;color:#cefeff;display: block;overflow: hidden;text-overflow: ellipsis;white-space: nowrap;}
  ...
  .detail_container .detail_btn{width:100%;text-align: right;color:#a7d7ff;font-size: 16px;margin-top: 0;}
  .detail_container .detail_btn a{  cursor:pointer;display: inline-block;vertical-align: middle;width: auto;}
...
<script>
  ...
  import  resource from '../../../../static/img/common/search/resource_nearby_single.png';
  import  resource_hover from '../../../../static/img/common/search/resource_nearby_hover_single.png';
  import search from '../../../../static/img/common/search/search_nearby_single.png';
  import search_hover from '../../../../static/img/common/search/search_nearby_hover_single.png'
